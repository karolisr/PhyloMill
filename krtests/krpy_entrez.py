...
def setUpModule():
    print('\nsetUpModule krpyEntrezTests')


def tearDownModule():
    print('\n\ntearDownModule krpyEntrezTests')


class krpyEntrezTests(unittest.TestCase):

    # print('krpyEntrezTests')
    ...
    def test_efetch(self):
        ...
        records = efetch_results[0]

        # there should be 4 records returned
        self.assertEqual(len(records), 4)

        # third record should be this
        self.assertTrue(records[2].startswith(
            '\nLOCUS       EF438954                 934 bp    DNA     linear'))
        ...
        # first record should be this
        self.assertTrue(records[0].startswith(
            'LOCUS       CAA05306                 218 aa            linear'))
        ...
        # very basic tests, testing for certain number of lines and specific
        # lines occurring in the output
        self.assertEqual(len(efetch_results[0]), 137)
        self.assertEqual(efetch_results[0][0], '<?xml version="1.0" ?>')
        self.assertEqual(efetch_results[0][3], '    <TaxId>24663</TaxId>')
