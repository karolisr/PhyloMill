    ...
    if args.test:
        ...
        if args.command == 'extract_loci':
            ...
            if args.samples:
                ...
                sequence_samples = krbioio.read_sequence_file(args.samples,
                    'fasta', ret_type='dict')
